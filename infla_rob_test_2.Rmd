---
title: "inflation 2(robust test_2)"
...
```{r}
ia_ar_out <- arima(y_ia[431:732],order=c(11,0,0))
ia_ar_out_coef <- ia_ar_out$coef
 
a <- matrix(rep(1,n_out),nrow=n_out,ncol=1)
ia_ar_out <- cbind(y_ia[432:731],y_ia[431:730],y_ia[430:729],
                   y_ia[429:728],y_ia[428:727],
                   y_ia[427:726],y_ia[426:725],y_ia[425:724],
                   y_ia[424:723],y_ia[423:722],y_ia[422:721],a)
...
```{r}
ia_ar_out_hat <- rep(0,300)
for (i in 1:300){
   va_m <- c(ia[i+431],ia[i+430],ia[i+429],
            ia[i+428],ia[i+427],ia[i+426],ia[i+425],ia[i+424],
            ia[i+423],ia[i+422],ia[i+421],1)
   va_m <- matrix(va_m,nrow=1)
   ia_ar_out_hat[i] <- va_m %*% ia_ar_coef
  ia[i+432] <- ia_ar_out_hat[i]
...
for (i in 1:300){
  va_m <- c(1,f_ia_pca_out[i,],ia[i+431],ia[i+430],ia[i+429],
            ia[i+428],ia[i+427],ia[i+426],ia[i+425],ia[i+424],
            ia[i+423],ia[i+422],ia[i+421])
  va_m <- matrix(va_m,nrow=1)
  ia_pca_out_hat[i] <- va_m %*% ia_pca_coef
  ia[i+432] <- ia_pca_out_hat[i]
...
for (j in 1:100){
  ...
  for (i in 1:300){
  va_m <- cbind(1,f_ia_ica_out[i,],ia[i+431],ia[i+430],ia[i+429],
            ia[i+428],ia[i+427],ia[i+426],ia[i+425],ia[i+424],
            ia[i+423],ia[i+422],ia[i+421])
  va_m <- as.matrix(va_m)
  ia_ica_out_hat[i] <- va_m %*% ia_ica_coef
  ia[i+432] <- ia_ica_out_hat[i]
...
for (i in 1:300){
  va_m <- c(1,f_ia_spca_out[i,],ia[i+431],ia[i+430],ia[i+429],
            ia[i+428],ia[i+427],ia[i+426],ia[i+425],ia[i+424],
            ia[i+423],ia[i+422],ia[i+421])
  va_m <- matrix(va_m,nrow=1)
  ia_spca_out_hat[i] <- va_m %*% ia_spca_coef
  ia[i+432] <- ia_spca_out_hat[i]
...
for (j in 1:100){
  ...
  va_m <- cbind(1,f_ia_sica_out[i,],ia[i+431],ia[i+430],ia[i+429],
            ia[i+428],ia[i+427],ia[i+426],ia[i+425],ia[i+424],
            ia[i+423],ia[i+422],ia[i+421])
  va_m <- as.matrix(va_m)
  ia_sica_out_hat[i] <- va_m %*% ia_sica_coef
  ia[i+432] <- ia_sica_out_hat[i]
